...
class OperationPlate extends PureComponent {
	...
	afterOpenOk = (databaseArray, conn, version) => {
		this.setState({
			openvisible: false,
		});
		this.setState({
		...
		localStorage.setItem('sqlServerConnectionString', conn);
		localStorage.setItem('sqlServerVersion', version);
		...
		const pageHeaderContent = (
			<div className={styles.pageHeaderContent}>
				<div className={styles.avatar}>
					<Avatar size="large" src="/database.png" />
				</div>
				<div className={styles.content}>
					<div className={styles.contentTitle}>
						...
						<Tooltip placement="top" title="打开/更换数据库">
							<Button
								shape="circle"
								size="small"
								type="primary"
